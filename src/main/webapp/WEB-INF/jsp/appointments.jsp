...
<head>
    ...
    <title>Appointments - Patient Case Management</title>
...
<div class="wrapper">
    ...
    <div id="content">
        <div class="top-navbar">
            <h4 class="m-0 fw-bold" style="color: #1e293b;">Appointments</h4>
        ...
        <div class="content-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="m-0 fw-bold">Schedule Overview</h5>
                <button class="btn btn-primary"><i class="fa-solid fa-calendar-plus me-2"></i>Appointment</button>
            </div>
            <p class="text-muted">View and manage upcoming patient appointments.</p>
        </div>
    </div>
</div>
