...
<head>
    ...
    <title>Cases - Patient Case Management</title>
...
<div class="wrapper">
    ...
    <div id="content">
        <div class="top-navbar">
            <h4 class="m-0 fw-bold" style="color: #1e293b;">Medical Cases</h4>
        ...
        <div class="content-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="m-0 fw-bold">Active & Historical Cases</h5>
                <button class="btn btn-primary"><i class="fa-solid fa-file-circle-plus me-2"></i>New Case</button>
            </div>
            <p class="text-muted">Manage ongoing treatments and historical medical case files.</p>
        </div>
    </div>
</div>
